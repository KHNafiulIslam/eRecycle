<?php
  ...
  $_SESSION['userid']='';
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM agent WHERE number = '$number' AND password = '$password'";
        $log = $conn->query($sql);
...
<main>
  ...
  <div class="container col-xl-10 col-xxl-8 ">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <form method="POST" action="a-log-in.php" style="padding:55px">
  <div class="mb-3">
  ...
  <button type="submit" name="submit" class="btn btn-primary">Submit</button>
    ...
    <p>Lets Create account? <a href="a-sign-in.php">Sign Up</a></p>
