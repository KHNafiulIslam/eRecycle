<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sq="INSERT INTO agent (name,number,location,postal,password) 
    VALUES('$name','$number','$location','$postal_code','$password')";
    if($conn->query($sq)===true){
      header('Location: a-log-in.php');
    }else{
...
<div class="container justify-content-center my-5">
    <div class="row ">
        ...
        <h1 style="text-align: center;"><?php echo $m;?></h1>
            <h2 class="title pt-4" >Agent Sign Up</h2>
            <form method="POST" action="a-sign-in.php" class="row g-3">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" name="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" require>
  </div>
  <div class="col-md-6">
